...
<div id="panel-container">
    <img src="{{ asset('assets/img/panel7.jpg') }}" alt="Fondo del panel" id="background-image">
    
    <div class="panel-content container-fluid px-4">
        <h1 class="mt-3" style="color: black;">PANEL DE CONTROL DE MODULOS</h1>
        <ol class="breadcrumb mb-4"></ol>
        <button id="togglePanel" class="btn btn-warning mb-3">MOSTRAR/OCULTAR PANEL</button>
        <div id="panel" class="row panel-container" style="display: none;">
