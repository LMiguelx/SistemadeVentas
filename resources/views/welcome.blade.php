...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-body-secondary">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" href="{{route('panel')}}">
                <img src="{{ asset('assets/img/icon.png') }}" alt="Logo" width="40" height="40" class="d-inline-block align-text-top">
                Sistema de venta
            </a>
    ...
    <section class="container-fluid bg-body-secondary text-center">
        <div class="container p-5">
            ...
            <div class="">
                <a href="{{route('login') }}" role="button" class="btn btn-primary">| Inicie seccion |</a>
            </div>
        </div>
